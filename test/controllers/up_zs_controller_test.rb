...
class UpZsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upz" do
    assert_difference('Upz.count') do
      post upzs_url, params: { upz: { Georeference: @upz.Georeference, Name: @upz.Name, district_area_id: @upz.district_area_id } }
    end
  ...
  test "should update upz" do
    patch upz_url(@upz), params: { upz: { Georeference: @upz.Georeference, Name: @upz.Name, district_area_id: @upz.district_area_id } }
